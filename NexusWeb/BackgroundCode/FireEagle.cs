...
namespace Yahoo.FireEagle
{
	...
	public class FireEagle : OAuthBase
	{
		...
		public string CONSUMER_KEY = Settings.Default.FireEagle_ConsumerKey;
		public string CONSUMER_SECRET = Settings.Default.FireEagle_ConsumerSecret;
		...
		public void GetRequestToken()
		{
			...
			if (token["oauth_token"] == null)
				throw new Exception("Missing oauth_token value in /oauth/request_token response from Fire Eagle");
			if (token["oauth_token_secret"] == null)
				throw new Exception("Missing oauth_token_secret value in /oauth/request_token response from Fire Eagle");
