...
namespace InstantMessage
{
	static class SuperTaskbarManager
	{
		...
		public static void Setup()
		{
			...
			string icondll = Path.Combine(Application.StartupPath, "NexusIM_Icons.dll"); // Path to dll that contains all icons
			...
			IMBuddy.onGlobalBuddyStatusChange += new EventHandler(IMBuddy_statusChange);
		...
		{
			JumpListLink link = new JumpListLink(Application.ExecutablePath, buddy.DisplayName);
		...
		{
			JumpListLink link = new JumpListLink(Application.ExecutablePath, tempname);
		...
		{
			JumpListLink status = new JumpListLink(Application.ExecutablePath, formalName);
